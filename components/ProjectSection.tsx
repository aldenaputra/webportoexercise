...
const projects = [
    {
        name: "Project 1",
        desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam ullamcorper consequat felis suscipit aliquet. Cras sit amet sodales est. Vestibulum ut magna ac quam rhoncus.",
